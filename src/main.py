...
from page.computer_overview import get_computer_overview


st.set_page_config(page_title="Asset Dashboard", page_icon="assets/favicon.ico")
...
if selected == "Computer Overview":
    get_computer_overview()
